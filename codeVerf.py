...
# 1、打开豆瓣官网 - 并将窗口最大化
browser = webdriver.Chrome(executable_path="E:\\Environment\chromedriver\chromedriver.exe")
...
browser.find_element_by_xpath('//*[@id="username"]').send_keys('13388958463')
browser.find_element_by_xpath('//*[@id="password"]').send_keys('cm000610')
