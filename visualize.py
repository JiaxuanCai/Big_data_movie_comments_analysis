...
SAVAPATH = '/home/hadoop/Ex2_WordCount/results/'
        ...
        def pie_position()	-> Pie:
            c = (
                Pie()
                    ...
                    .set_global_opts
                    (
                    title_opts=opts.TitleOpts(title='饼图可视化',title_textstyle_opts=opts.TextStyleOpts(font_family="Microsoft YaHei")), # 设置标题
